...
function createEditablePlayers(game: RecordingDraftGame | null) {
      ...
      <KeyboardAvoidingView
        ...
        <SurfaceCard style={styles.sheet} tone="raised">
          ...
          <View style={styles.header}>
            <Text style={styles.title}>Edit Scoreboard Draft</Text>
          ...
          <KeyboardAwareScrollView
            ...
            {previewPlayers.length > 0 ? (
              <View style={styles.previewWrap}>
                <MultiPlayerFrameGrid players={previewPlayers} selectedPlayerKeys={selectedPlayerKeys} />
              </View>
            ) : null}
          ...
          <View style={styles.actions}>
            <Pressable
              ...
              {saving ? (
                ...
                <Text style={styles.primaryButtonText}>Save draft game</Text>
              )}
            </Pressable>
